<?php
/**
 * Product quantity input — AwA Bio Foods
 * Override : supprime les boutons +/- injectés par WooCommerce/plugins via hooks.
 *
 * @package awa-child
 * @see     woocommerce/global/quantity-input.php (v10.1.0)
 */
